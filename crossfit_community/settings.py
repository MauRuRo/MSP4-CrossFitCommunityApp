"""
Django settings for crossfit_community project.
...
AUTHENTICATION_BACKENDS = [
    # copied from allauth documentation (installation)
...
if "USE_AWS" in os.environ:
    # No cache control required because files change all the time.
    # Bucket config:
    AWS_STORAGE_BUCKET_NAME = "hero-community"
...
CRONTAB_EXECUTABLE = '/workspace/MSP4-CrossFitCommunityApp/crontab'
